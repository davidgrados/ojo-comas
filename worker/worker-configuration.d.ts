/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ca7afce123530227aeeefb00a2785a14)
// Runtime types generated with workerd@1.20260916.1 2026-09-16 
interface __BaseEnv_Env {
	FOTOS: R2Bucket;
	DB: D1Database;
	ENTORNO: "produccion" | "local";
	TURNSTILE_SITEKEY: "REEMPLAZAR-CON-TU-SITEKEY-REAL" | "1x00000000000000000000AA";
	TURNSTILE_HOSTNAMES: "REEMPLAZAR-CON-TU-DOMINIO-DE-PAGES" | "*";
	TURNSTILE_ACTIONS: "reporte,apoyo";
	MAX_FOTO_BYTES: "2097152";
	MAX_REPORTES_POR_HORA: "8" | "40";
	MAX_APOYOS_POR_HORA: "30";
	CORS_ORIGINS: "REEMPLAZAR-CON-TU-DOMINIO-DE-PAGES" | "http://localhost:8788,http://127.0.0.1:8788,http://localhost:8787,http://127.0.0.1:8787,http://localhost:3000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENTORNO" | "TURNSTILE_SITEKEY" | "TURNSTILE_HOSTNAMES" | "TURNSTILE_ACTIONS" | "MAX_FOTO_BYTES" | "MAX_REPORTES_POR_HORA" | "MAX_APOYOS_POR_HORA" | "CORS_ORIGINS" | "TURNSTILE_SECRET" | "ADMIN_TOKEN" | "IP_SALT">> {}
}
